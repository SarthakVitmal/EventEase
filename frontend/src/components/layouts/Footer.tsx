...
export default function Footer() {
  return (
    <footer className="flex justify-center w-full py-12 md:py-16 bg-gray-900 text-gray-300">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-sm text-gray-400 mb-4">
                Discover and book the best events in your city with just a few clicks.
              </p>
            ...
            <div>
              ...
              <div className="flex">
                <Input
                  ...
                  className="rounded-r-none bg-gray-800 border-gray-700 focus-visible:ring-purple-500"
                />
